...
~47.8k lines of backend Python across 310 modules, ~17.3k lines of frontend TypeScript across 72 files, 1,999 backend tests, 109 frontend tests.
...
| Weekly Review, Placed Bets, Live Status, Round Readiness, Team Selection, System Health | Weekly shortlist review workflow, a personal bet ledger with settled P&L, live-cycle operational health, weather/lineup pre-bet checklist, manual lineup entry, API/DB connectivity check |
...
- Frontend test coverage is real but still comparatively light relative to the backend — 109 Vitest tests across 6 files vs. 1,999 backend tests; UI logic is exercised far less thoroughly than the modelling/pricing core.
...
**Tests**
```bash
cd backend && .venv\Scripts\python -m pytest -q   # 1,999 tests
cd frontend && npm run build                       # tsc -b + vite build
cd frontend && npm test                             # vitest, 109 tests
```
